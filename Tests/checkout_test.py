...
class TestCheckout(BaseTest):
    ...
    async def test_checkout(self,prepare_checkout, name, lastname, post_code, status):

        await self.checkout_step_1_page.fill_checkout_form(name, lastname, post_code)
