...
class CheckoutStepOnePage(BasePage):
    ...
    async def fill_checkout_form(self, first_name, last_name, postal_code):
        fields = [
            (self.page.locator(self.FIRST_INPUT_FIELD), first_name),
            (self.page.locator(self.SECOND_INPUT_FIELD), last_name),
            (self.page.locator(self.POST_INPUT_FIELD), postal_code)
        ]
